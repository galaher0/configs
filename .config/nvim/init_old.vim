...
" Run Python, C and Ruby files by Ctrl+h
...
autocmd FileType ruby map <buffer> <C-h> :w<CR>:exec '!ruby' shellescape(@%, 1)<CR>
autocmd FileType ruby imap <buffer> <C-h> <esc>:w<CR>:exec '!ruby' shellescape(@%, 1)<CR>
